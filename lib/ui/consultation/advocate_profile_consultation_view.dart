...
class _AdvocateProfileConsultationViewState
      ...
      child: Column(
        children: [
          ...
          ConsultationCard(
            ...
            title: Strings.messageConsultation,
            subtitle: Strings.messageConsultationSubtitle,
            price: consultationCharges.offline.price,
            time: consultationCharges.offline.time,
            onPressed: () => onTap(
              consultationCharges.offline.price,
              consultationCharges.offline.time,
  ...
  Future<void> onTap(int price, int duration, ConsultationType type) async {
