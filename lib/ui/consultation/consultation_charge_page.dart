...
class _ConsultationChargesPageState extends State<ConsultationChargesPage> {
  ...
  void initState() {
    if (widget.model != null) {
      ...
      offlineTime = TextEditingController(text: details.offline.time.toString());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Consultation Charges" , style: TextStyle(color: Colors.black),),
          ...
          child: Column(
            children: [
              ...
              ConsultationInputWidget(
                time: offlineTime,
                price: offlinePrice,
                heading: Strings.offlineConsultation,
              ),
              SizedBox(height: 30),
              RaisedButton(
                    ...
                    ConsultationCharges consultationCharges =
                      ...
                      chat: Charges(
                        ...
                        time: int.parse(chatTime.text),
                          ...
                          offline: Charges(
                            price: int.parse(offlinePrice.text),
                            time: int.parse(offlineTime.text),
                          ),
                    );
